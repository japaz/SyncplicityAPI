...
public class FileData {
	...
	String LastWriteTimeUtc; // A UTC timestamp of when the file was last
								// modified.
	Integer Status; // 1 for Added (the file exists), 3 for Removed (the file
					// has been deleted).
	Long LatestVersionId; // The ID of the latest version of this file.
	String ThumbnailUrl; // The URL of a 40x40 thumbnail version of the file, if
	...
	public FileData(String virtualPath, String fileName, Long length,
			String hash, String creationTimeUtc, String lastWriteTimeUtc,
			Long syncPriority, FileDataStatus status) {
	...
	public FileData(String virtualPath, String fileName, String creationTimeUtc, String lastWriteTimeUtc,
			Long syncPriority) {
		VirtualPath = virtualPath;
		Filename = fileName;
		CreationTimeUtc = creationTimeUtc;
